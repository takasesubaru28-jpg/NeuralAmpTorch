...
def train(config):
    ...
    validation_input = paths.get("validation_input_wav", input_wav)
    validation_target_dir = paths.get("validation_target_dir", target_dir)
    ...
    # Both training implementations read the same preprocessed shared data.
    # Do not regenerate it inside an individual project directory.
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if (epoch + 1) % 10 == 0:
                ...
                val_input = validation_input
                val_target = validation_target_dir
